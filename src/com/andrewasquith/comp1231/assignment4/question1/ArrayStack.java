...
// import the Arrays class for the copy operation
import java.util.Arrays;
// import the interface definition on which the implementation is based
import jsjf.StackADT;
// re-use the exception to mirror the original implementation
import jsjf.exceptions.EmptyCollectionException;

/**
 * An implementation of the generic ArrayStack provided
 * in chapter 12. The class implements the provided interface
 * to ensure that this implementation conforms to the original
